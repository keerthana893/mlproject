...
class DataIngestionConfig:
    train_data_path:str=os.path.join('artifact',"train.csv")  # train data i.e o/p is stored in artifact and its name is train.csv
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):   # to read from data base
